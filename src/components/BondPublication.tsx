...
function BondPublicationPage(props: any) {
    ...
    if (authState.role === Role.NaturalPerson) {
        userData = <Fragment>
            <Typography className={classes.title} variant="h5">Datos del Comprador</Typography>
            <Grid container justify="flex-start" spacing={3}>
                ...
                <Grid item xs={12} md={4} className={classes.center}>
                    <Button variant="contained" color="primary" >Ver Perfil</Button>
                </Grid>
            </Grid>
        </Fragment>
    } else {
    ...
    return (
        <Fragment>
            <Paper className={classes.paper}>
                    ...
                    <Grid container justify="flex-start" spacing={3}>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={toRate(data.bondPublication?.bond.bondInput.interestRateType)}
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={toFrequency(data.bondPublication?.bond.bondInput.capitalization)}
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={data.bondPublication?.bond.bondInput.annualDiscountRate}
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={data.bondPublication?.bond.bondInput.emmitionDate.toLocaleDateString()}
                            />
                        </Grid>
                ...
                <div className={classes.subContent}>
                    <Typography className={classes.title} variant="h5">Resultados del Bono</Typography>
                    ...
                    <Grid container justify="flex-start" spacing={3}>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={toFrequency(data.bondPublication?.bond.bondOutput.couponFrequency)}
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={data.bondPublication?.bond.bondOutput.annualEfectiveRate}
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={data.bondPublication?.bond.bondOutput.initialEmmiterCosts}
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} md={4}>
                            <TextField
                                ...
                                value={data.bondPublication?.bond.bondOutput.initialHolderCosts}
                            />
                        </Grid>
